...
class category_apis extends elearner_courses_tbl  {
    // TABLE
    private function table(){ return $this->category_tbl();}
    ...
    /******************************** Retrive Functions ***************************************/
    /******************************************************************************************/
    public function category_apis_apis_get_all ($args = NULL ){
       $getApps = new get_applications();
       return $getApps->get_all_rows ( $this->table() ,$args);   
    }
    public function category_apis_search_apis( $args, $operatorType /*Or - and */){
       $getApps = new get_applications();
       return $getApps->get_data_according_to_array($this->table(), $args, '%', $operatorType);
    }
    public function category_apis_get_by_values ($args, $type /*OR-AND*/, $operatorType = NULL ){
       $getApps = new get_applications();
       return $getApps->get_data_according_to_array($this->table(), $args, $type, $operatorType);
    }
    public function category_apis_check_exist ($args, $type = NULL){
       $getApps = new get_applications();
    ...
    public function category_apis_add_new_field ($args = []){
               // Add Module Apis
    ...
    /******************************** Update Functions *******************************************/
    /******************************************************************************************/
    public function category_apis_update_fields ($column_args =[] , $value_args = []){
   ...
   /******************************************************************************************/
    /******************************** Delte Functions *******************************************/
    /******************************************************************************************/   
    public function category_apis_delete_fields ($args=[]){
