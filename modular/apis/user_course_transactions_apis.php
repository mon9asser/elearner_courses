...
class user_apis extends elearner_courses_tbl  {
    // TABLE
    private function table(){ return $this->course_transaction_tbl();}
    ...
    /******************************** Retrive Functions ***************************************/
    /******************************************************************************************/
    public function usercoursetransactions_application_apis_get_all ($args = NULL ){
       $getApps = new get_applications();
       return $getApps->get_all_rows ( $this->table() ,$args);   
    }
    public function usercoursetransactions_application_search_apis( $args, $operatorType /*Or - and */){
       $getApps = new get_applications();
       return $getApps->get_data_according_to_array($this->table(), $args, '%', $operatorType);
    }
    public function usercoursetransactions_application_get_by_values ($args, $type /*OR-AND*/, $operatorType = NULL ){
       $getApps = new get_applications();
       return $getApps->get_data_according_to_array($this->table(), $args, $type, $operatorType);
    }
    public function usercoursetransactions_application_check_exist ($args, $type = NULL){
       $getApps = new get_applications();
    ...
    public function usercoursetransactions_application_add_new_field ($args = []){
               // Add Module Apis
    ...
    /******************************** Update Functions *******************************************/
    /******************************************************************************************/
    public function usercoursetransactions_application_update_fields ($column_args =[] , $value_args = []){
   ...
   /******************************************************************************************/
    /******************************** Delte Functions *******************************************/
    /******************************************************************************************/   
    public function usercoursetransactions_application_delete_fields ($args=[]){
