...
<html lang="en">
  ...
  <body>
      ...
      <section class="container-fluid section-valuable">
              ...
              <div class="single-item">
                  ...
                  <div>
                   ...
                   <div>
                    <div class="feauture-course-container text-center">
                        <div class="image-container">
                            <div style="background-image: url(courses_covers/course-5-450x450.jpg);" class="img-course-block">
                             <div class="mask-layer-courses"></div>
                            </div>
                        </div>
                        <b class="course-name-container">
                              Learning jQuery Mobile for<br /> Beginners 
                        </b>
                        <p class="descripe-course-feauture">
                            <span class="groups">
                                <i class="fa fa-group"></i>
                 ...
                 <div>   
                  <div class="feauture-course-container text-center">
                        <div class="image-container">
                            <div style="background-image: url(courses_covers/course-10-450x450.jpg);" class="img-course-block">
                             <div class="mask-layer-courses"></div>
                            </div>
                        </div>
                        <b class="course-name-container">
                             Your Complete Guide to<br /> Photography
                        </b>
                        <p class="descripe-course-feauture">
                            <span class="groups">
                                <i class="fa fa-group"></i>
