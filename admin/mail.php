        ...
        <div class="container">
            <div class="row">
                ...
                <div class="span9">
                    ...
                    <form action="controler/email_controller.php" method="post">
                        <textarea name="textbox" placeholder="Write your email address then click enter this email will send to all users" style="height: 300px;"></textarea>
                        <input type="submit" value="Send Email" id="sender-btn" style="float: right;" class="btn btn-success" />
                    </form>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#sender-btn').click(function () {
            ...
            if(textbox == '')
                {
                    alert("Please you must fill the-up box then send email");
                    return false ;
                }
